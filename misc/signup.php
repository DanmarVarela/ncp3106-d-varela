        ...
        <div class="inputs">
            <div class="signup-inputBox-wrapper" id="test">
                ...
                <div class="signup-inputBox" id="lastName">
                    <input type="text" name="lastName" placeholder="Last Name" oninput="validateName('lastName')"> 
                </div>
            </div>
            <div class="signup-inputBox-wrapper">
                <div class="signup-inputBox" id="firstName">
                    <input type="text" name="firstName" placeholder="First Name" oninput="validateName('firstName')">  
                </div> 
            ...
            <div class="signup-inputBox-wrapper">
                <div class="signup-inputBox" id="studentNumber">
                    <input type="text" name="studentNumber" placeholder="Student Number" oninput="validateStudNum('studentNumber')" maxlength="11">
                </div>
                <div class="signup-inputBox" id="yearLevel">
            ...
            <div class="signup-inputBox-wrapper">
                <div class="signup-inputBox" id="email">
                    <input type="email" name="email" placeholder="name@ue.edu.ph" oninput="validateEmail('email')">
                </div>
            </div>
        ...
        <div class="inputs">
            <div class="inputBox-wrapper">
                <div class="inputBox-container">
                    ...
                    <input type="text" name="signupUsername" placeholder="Username" oninput="validateUserName('signupUsername')">
                </div>
            </div>
            <div class="inputBox-wrapper">
                <div class="inputBox-container">
                    <img src="../src/key.svg" alt="failed to load image">
                    <input type="password" name="signupPassword" placeholder="Password" oninput="validatePassword('signupPassword')">
                </div>
            </div>
